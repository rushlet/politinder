...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Swing = _interopRequireWildcard(_swing);

	var _policies = __webpack_require__(17);
	...
	window.fetch('../../policies.json').then(function (response) {
	    return response.json();
	}).then(function (policies) {
	    window.fetch('../../categories.json').then(function (response) {
	        return response.json();
	    }).then(function (categories) {
	        window.fetch('../../average_mps.json').then(function (response) {
	            return response.json();
	        }).then(function (policyAgreement) {
	            ready({
	                policies: policies,
	...
	function ready(data) {
	    (0, _policies2.default)(data.policies, data.categories);
	    var cards = Array.from(document.querySelectorAll('.policies-list li'));
	    ...
	    stack.on('throwout', function (e) {
	        ...
	        if (activated === false) {
	            ...
	            resultsButton.addEventListener("click", function () {
	                (0, _displayResults2.default)(userProfile, partyTotals);
	            }, false);
	            activated = true;
	        }
